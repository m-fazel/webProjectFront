...
function NavbarPlayer() {
    ...
    return (
        <nav className="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
            ...
            <Link className={`navbar-brand`} to="/dashboard-player">سوال پیچ</Link>
            <button className="navbar-toggler" type="button" data-bs-toggle="collapse"
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${isActive('question-player-list')} ${isActive('designer-view')} ${isActive('answering-player')}`} to="/question-player-list">مدیریت سوالات</Link>
                        </li>
                        <li className="nav-item">
